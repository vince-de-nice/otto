...
import 'package:otto/domain/entities/math/constants.dart';
import 'package:otto/domain/entities/math/dmm.dart';
import 'package:otto/domain/entities/math/dms.dart';
...
class Angle {
  ...
  DMM toDMM() {
    ...
    return DMM(
        ...
        minutes: minutes.toInt(),
        decimalMinutes: decimalMinutes.toInt());
  }
