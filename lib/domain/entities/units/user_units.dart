...
// /// @return True if buffer long enough, False otherwise
//  String
// formatUserVerticalSpeed(double value, { bool includeUnit = true, bool includeSign = true}) {
//   return formatVerticalSpeed( value, Units.getUserVerticalSpeedUnit(),
//                       includeUnit, includeSign);
// }
...
//  return  formatUserVerticalSpeed(value, includeUnit, includeSign);
